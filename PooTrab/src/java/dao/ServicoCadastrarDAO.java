 ...
 * @author Usuario
 */
public class ServicoCadastrarDAO {
 ...
 private final String TIPO_BANCO = "mysql"; // ou "postgres"
    ...
    public void cadastrar(Servico s) throws ClassNotFoundException, SQLException, Exception {
        Connection con = getConnection();
        PreparedStatement comando = con.prepareStatement("insert into Servico (tipo, descricao, preco, confirmPagamento, dataGarantia, dataExecucao, clienteNome, clienteCpf,clienteTelefone,clienteIdade) values (?,?,?,?,?,?,?,?,?,?)");
    ...
    public void cadastrar(Servico.ServicoBuilder s) {
